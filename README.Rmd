...
```{r, echo = FALSE, message = FALSE, warning = FALSE}
# Helper function to create a Markdown link or return an empty string
make_link <- function(url, text) {
  ifelse(is.na(url), "", paste0("[", text, "](", url, ")"))
}

# Define the data
presentation_data <- dplyr::tribble(
  ~venue, ~presenters, ~title, ~url_slides, ~url_video,
  "2022 R/Pharma", "Christina Fillmore", "Why do I spend all my life formatting tables?", NA_character_, "[https://www.youtube.com/watch?v=00lGhuANUJw](https://www.youtube.com/watch?v=00lGhuANUJw)",
  "2023 R/Pharma", "Becca Krouse", "Everyone's Invited: A Case Study on Bridging the Usability Gap", NA_character_, "[https://www.youtube.com/watch?v=Zg1LPJSO0kQ](https://www.youtube.com/watch?v=Zg1LPJSO0kQ)",
  "2022 R/Pharma Workshop", "Christina Fillmore, Ellis Hughes and Thomas Neitmann", "Clinical Reporting in R (Day 2)", NA_character_, "[https://www.youtube.com/watch?v=rYflZhFDSZQ](https://www.youtube.com/watch?v=rYflZhFDSZQ)",
  "2023 R/Pharma Workshop", "Thomas Neitmann, Pawel Rucki and Ellis Hughes", "Leveraging and contributing to the the pharmaverse for clinical trial reporting in R", "[https://github.com/posit-conf-2023/r-pharma](https://github.com/posit-conf-2023/r-pharma)", NA_character_,
  "Posit conf 2024", "Daniel D. Sjoberg, Becca Krouse, Ellis Hughes, Andrew Bates and Casey Aguilar-Gervase", "Flavors of the pharmaverse", "[https://posit-conf-2024.github.io/pharmaverse/](https://posit-conf-2024.github.io/pharmaverse/)", NA_character_,
  "Posit conf 2024", "Becca Krouse", "Stitch by Stitch: The Art of Engaging New Users", NA_character_, "[https://www.youtube.com/watch?v=R3VMij_1aSE](https://www.youtube.com/watch?v=R3VMij_1aSE)",
  "R in Pharma 2024", "Daniel D. Sjoberg, Becca Krouse and Jack Talboys", "Unlocking Analysis Results Datasets (ARDs)", "[https://www.danieldsjoberg.com/ARD-RinPharma-workshop-2024/](https://www.danieldsjoberg.com/ARD-RinPharma-workshop-2024/)", NA_character_,
  "PHUSE US Connect 2025", "Daniel D. Sjoberg and Becca Krouse", "Analysis Results Datasets Using Open-Source Tools from the {pharmaverse}", "[https://www.danieldsjoberg.com/ARD-PHUSE-workshop-2025/](https://www.danieldsjoberg.com/ARD-PHUSE-workshop-2025/)", NA_character_,
  "Posit conf 2025", "Daniel D. Sjoberg, Becca Krouse, Ben Straub and Rammprasad Ganapathy", "End-to-End Submissions in R with the Pharmaverse", "[https://posit-conf-2025.github.io/pharmaverse/](https://posit-conf-2025.github.io/pharmaverse/)", NA_character_
)

#  Transform the data into a Markdown-friendly format
presentation_data |>
  dplyr::mutate(
    # Convert URLs to Markdown links (simpler than Font Awesome icons)
    Slides = make_link(url_slides, "Slides"),
    Video = make_link(url_video, "Video")
  ) |>
  ...
  #  Use kable to output a native Markdown table
