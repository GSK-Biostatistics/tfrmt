...
As a final note, column names for the big N's should match the ARD column names not any future names. So regardless, if column names get changed in the `col_plan`, the column name for the big N's should reflect the column name of that column you want it to go in the ARD. The big N's will still be added if names do get updated.  
```{r}
n_span_tfrmt %>% 
