...
## Adding column spanners
 ...
 The `col_plan` accepts a combination of tidyselect expressions, column names, and/or span structure (`span_structure`) objects. Recall that `*_structure` objects are for modifying the *contents* (i.e., text) of the table; in the `col_plan`, we use `span_structure`s to add column spanners. These are placed strategically in the `col_plan` to inform `tfrmt` of the hierarchy of spanners and columns.
...
<p align="center"><img src="../man/figures/tfrmt-span_structure.png" width="100%"></p>
