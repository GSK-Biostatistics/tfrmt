...
In order to change the order of spanning groups, we will need use `contains()`. This can make change the order of the spanning headers relatively easy, but if we can't change the order of columns with the same name. 
```{r}
tfrmt(
    group = group,
    label = label,
