...
tfrmt(
  ...
  col_style_plan =  col_style_plan(
    element_col(align = c("."), col = `p-value`),
    element_col(align = c(".", ",", " "), col = starts_with("trt"))
    )
  ) %>% 
  print_to_gt(dat)
```
...
Width is set as specific value in number of characters wide the column is allowed to be at most. This value is specified by passing a character or numeric value to the "width" argument of `element_col`, taking the format of "##" or ##, where "##" is the number of characters.
...
tfrmt(
  ...
  col_style_plan =  col_style_plan(
    element_col(width = "10", col = label),
    element_col(align = c("."), width = "10", col = `p-value`),
    element_col(align = "left", width = "5", col = trt1),
    element_col(align = "right", width = "5", col = trt2))
  ) %>% 
  print_to_gt(dat)
