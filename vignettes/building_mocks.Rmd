...
```{r}
initial_df <- crossing(label = c("label 1", "label 2", "label 3"),
...
df <- initial_df |>
  ...
  mutate(ord1 = rep(seq(1:length(unique(initial_df$label))), each = nrow(initial_df)/length(unique(initial_df$label)) ))
