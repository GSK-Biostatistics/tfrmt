...
When a tfrmt gets layered, the values in the first tfrmt are replaced with the values in the second tfrmt. The exception to this rule is the "body_plan", which will stack the plans together. To change this behavior see the `layer_tfrmt()` documentation.
...
labs_data_subset <- tfrmt::labs_data %>% 
  filter(
