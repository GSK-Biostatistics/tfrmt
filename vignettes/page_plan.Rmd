...
Notes can sometimes end up not being very human readable. We could change them (let's say from `"rowlbl1: Age (y), grp: cat"` to `"Row label 1 - Age (y), Group - cat"`) by supplying a transformation function to `page_plan()` - i.e. the `transform` argument.
