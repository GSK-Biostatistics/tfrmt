...
*Note: {tfrmt} version 0.3.0 brings support for multiple row label columns! See the Row Group Plan vignette for details*
...
![Image of the Summary of Number of Subjects By Site table from the CDISC pilot](../man/figures/summary_subj_by_site.png)
