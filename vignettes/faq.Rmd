...
### How do you add a newline within a column header?

To add a newline to your column header you need to include the markdown syntax `<br/>` in your character string. An example of this can be seen below:
...
es_data <-tibble(rowlbl1 =c(rep("Completion Status",12),rep("Primary reason for withdrawal",28)),
                 ...
                 column=c(rep(c("Placebo<br/>(N=48)","Treatment<br/>(N=38)"),20)),
