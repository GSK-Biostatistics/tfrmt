...
For formatting specific values of the param variable, `frmt` objects must be named according to the param. The following code will format all values will where the param value equals "pval", regardless of group, label, or column value.
