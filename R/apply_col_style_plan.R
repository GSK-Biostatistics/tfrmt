...
#' @importFrom dplyr select tibble slice n cur_column pull ungroup
...
#' @param align Alignment to be applied to column.
#'
#' @importFrom dplyr lag left_join tibble summarise row_number select filter
