...
[`cards::ard_stack()`](https://rdrr.io/pkg/cards/man/ard_stack.html)
then shuffled with `[shuffle_card()]`.

If the data is the result of a hierarchical ard stack (with
[`cards::ard_stack_hierarchical()`](https://rdrr.io/pkg/cards/man/ard_stack_hierarchical.html)
or
[`cards::ard_stack_hierarchical_count()`](https://rdrr.io/pkg/cards/man/ard_stack_hierarchical.html)),
