test_that("basic tfrmt - title", {
    ...
    expect_equal(t_frmt$label, rlang::quo())
    expect_equal(t_frmt$param, rlang::quo())
    expect_equal(t_frmt$value, rlang::quo())
...
test_that("layering tfrmt - default table elements - func/tfrmt", {
    ...
    expect_equal(t_frmt_layered$label, rlang::quo())
    expect_equal(t_frmt_layered$param, rlang::quo())
    expect_equal(t_frmt_layered$value, rlang::quo())
...
test_that("advanced tfrmt - tfrmt maker", {
    ...
    tfrmt_maker_2 <- function(title, group, label, param_val) {
        tfrmt_inputs <- quo_get(
            c("group", "label", "param_val"),
            as_var_args = "group",
            as_quo_args = c("label", "param_val")
        )
