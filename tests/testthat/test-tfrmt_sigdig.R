...
test_that("varying group/label inputs",{
  ...
  t_out <- tfrmt_sigdig(data_sigdig = dat_sigdig)
  ...
  expect_warning(
    ...
    paste0("`data_sigdig` input does not contain the following group params: grp3")
  )
  ...
  expect_error(
    ...
    paste0("`data_sigdig` input does not contain any of the specified group/label params:\n",
           "group: group4\n",
           "label: group3")
  )
...
test_that("group vars specified in tfrmt but not sigdig data are represented in body_plan",{
  ...
  expect_warning(
    ...
    paste0("`data_sigdig` input does not contain the following group params: newgrp")
  )
