...
test_that("tfrmt is as expected", {
    ...
    expect_error(
        print_to_ggplot(tfrmt_1, test_data),
        "column variable required for print_to_ggplot"
    )
    expect_error(
        print_to_ggplot(tfrmt_2, test_data),
        "label variable required for print_to_ggplot"
    )
    expect_error(
        print_to_ggplot(tfrmt_3, test_data),
        "param variable required for print_to_ggplot"
    )
    expect_error(
        print_to_ggplot(tfrmt_4, test_data),
        "value variable required for print_to_ggplot"
    )
})
