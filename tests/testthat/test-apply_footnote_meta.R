test_that("applying footnote meta column val", {
  ...
  es_data <- tibble::tibble(
    ...
    value = c(
      ...
      100 / 48, 100 / 38, 1, 4, 100 / 48, 400 / 38, 1, 0, 100 / 48, 0, 2, 3,
      200 / 48, 300 / 38
    )
  )
    ...
    body_plan = body_plan(
      frmt_structure(
        ...
        frmt_combine(
          "{n} {pct}",
          n = frmt("xxx"),
          pct = frmt_when("==100" ~ "", "==0" ~ "", TRUE ~ frmt("(xx.x %)"))
        )
      )
    ),
    footnote_plan = footnote_plan(
  ...
  expect_equal(
    ...
    list(
      list(
        "col" = "Treatment column___tlang_delim___Placebo",
        "spanning" = FALSE,
  ...
  dd <- tibble::tibble(
    ...
    dplyr::bind_cols(
      ...
      value = c(
        ...
        1, 1, 100 / 48, 100 / 38, 1, 4, 100 / 48, 400 / 38, 1, 0, 100 / 48, 0,
        2, 3, 200 / 48, 300 / 38
      )
    )
