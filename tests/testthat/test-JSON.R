...
test_that("page_plan() roundtrip to JSON with transform", {
    ...
    func_pp_lambda_from_json <- rlang::as_function(
        page_plan_lambda_from_json$page_plan$transform
    )
    ...
    func_pp_function <- rlang::as_function(
        page_plan_function$page_plan$transform
    )
    func_pp_function_from_json <- rlang::as_function(
        page_plan_function_from_json$page_plan$transform
    )
...
test_that("json read/write", {
    ...
    expect_equal(read_tfrmt, test_tfrmt, ignore_attr = TRUE)
